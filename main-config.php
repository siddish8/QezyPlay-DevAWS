...
define("DB_HOST", "ideabytesdb.c6hujshgwzfd.us-east-1.rds.amazonaws.com");
define("DB_USERNAME", "tradmin_newqezy");
define("DB_PASSWORD", "tradmin_newqezy");
define("DB_NAME", "tradmin_newqezy");

define("ENV", "live");  //dev (or) live
define("ADMIN_EMAIL1", "admin@qezy.tv");
...
$headers .= 'From: QezyPlay Analytics <admin@qezytv.com>' . "\r\n";
