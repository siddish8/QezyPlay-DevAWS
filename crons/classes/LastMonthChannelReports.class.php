...
class LastMonthChannelReports
{
	function lastMonthChannelByChannelHits(){
		global $dbcon;
		global $channel_id;
	...
	function lastMonthChannelByChannelDuration(){
		global $dbcon;
		global $channel_id;
		global $friendlyIpsCond;
		global $friendlyWebsites;
	...
	function lastMonthChannelDuration()
	{
		global $dbcon;
		global $date;
		global $date1;
