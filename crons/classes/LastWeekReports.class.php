...
class LastWeekReports
{
	function lastWeekByChannelHits(){
		...
		$sql = "SELECT count(*) as hits,a.page_id,b.post_title as channel FROM visitors_info a inner join wp_posts b on b.ID=a.page_id inner join wp_term_relationships c on a.page_id=c.object_id WHERE 1 and b.post_status='publish' and b.post_type='post' and c.term_taxonomy_id=".$boq_id." ".$cond." GROUP BY a.page_id";	
