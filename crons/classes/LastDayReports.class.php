...
class LastDayReports
{
	function lastDayByChannelHits(){
		global $dbcon;
		global $channel_id;
		...
		$sql = "SELECT count(*) as hits,a.page_id,b.post_title as channel,a.country FROM visitors_info a inner join wp_posts b on b.ID=a.page_id inner join wp_term_relationships c on a.page_id=c.object_id WHERE 1 and b.post_status='publish' and b.post_type='post' and c.term_taxonomy_id=".$boq_id." ".$cond." GROUP BY a.page_id";
	...
	function lastDayByChannelDuration(){
		global $dbcon;
		global $channel_id;
		global $friendlyIpsCond;
		global $friendlyWebsites;
		...
		$sql = "SELECT sum(duration) as duration,a.page_id,b.post_title as channel FROM visitors_info a inner join wp_posts b on b.ID=a.page_id inner join wp_term_relationships c on a.page_id=c.object_id WHERE 1 AND duration > 0 AND play = 1 and b.post_status='publish' and b.post_type='post' and c.term_taxonomy_id=".$boq_id." ".$cond." GROUP BY page_id";
	...
	function lastDayHits()
	{
		...
		$sql = "SELECT sum(duration) as dur,count(*) as hits,a.page_id,b.post_title as channel,a.country FROM visitors_info a inner join wp_posts b on b.ID=a.page_id inner join wp_term_relationships c on a.page_id=c.object_id WHERE 1 and b.post_status='publish' and b.post_type='post' and c.term_taxonomy_id=".$boq_id." ".$cond." GROUP BY a.country,a.page_id";

		$sqlX = "SELECT sum(duration) as dur,count(*) as hits,a.country FROM visitors_info a inner join wp_posts b on b.ID=a.page_id inner join wp_term_relationships c on a.page_id=c.object_id WHERE 1 and b.post_status='publish' and b.post_type='post' and c.term_taxonomy_id=".$boq_id." ".$cond." GROUP BY a.country";
