...
$octo_js=$wpdb->get_var("SELECT octo_js from channels where id=".$post_id." ");
$vodurl=$wpdb->get_var("SELECT vodurl from channels where id=".$post_id." ");
$vod_js=$wpdb->get_var("SELECT vod_octo_js from channels where id=".$post_id." ");
$short_vodurl=$wpdb->get_var("SELECT short_vodurl from channels where id=".$post_id." ");
$short_vod_js=$wpdb->get_var("SELECT short_vod_octo_js from channels where id=".$post_id." ");
...
displayVideo($vidurl,$imgurl,$session_id,$post_id,$ip_address,$user_agent,$page_ref,$post_title,$post_name,$page_url,$country_code,$country_name,$state,$city,$geoinfo_status,$octo_js,$vodurl,$short_vodurl,$vod_js,$short_vod_js);
