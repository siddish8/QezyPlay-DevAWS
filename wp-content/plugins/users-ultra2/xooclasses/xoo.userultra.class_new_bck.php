...
//$forgot_pass .= '<div id="user_name_email_err_div" class="xoouserultra-field" style="display:none">    <label id="user_name_email_label" class="xoouserultra-field-type"></label><div id="user_name_email_err" class="alert alert-danger xoouserultra-field-value"></div>   </div>';
				...
				$display .= '<div class="xoouserultra-field-value">';
					...
					switch($field) {
						...
						case 'text':
							...
							if($meta=="phone")
							{
								 $display .= $this->get_countries_select(); 
                        ...
                        <div style="display:none" id="phone_err"></div>*/
							...
							$display .= '<input type="hidden" name="ph" value="" id="ph" />';
							//$help="Include [+][Countrycode][PhoneNo.] Ex: +919000000000";
							$help="Please enter valid phone no";
