...
class XooMessaging extends XooUserUltraCommon 
{
	...
	public function set_headers() {   			
		...
		$header .= "From:QezyPlay<admin@qezy.tv>" . "\r\n";
		//$header ="MIME-Version: 1.0\n"; 
	...
	public function  send ($to, $subject, $message)
	{
		...
		{	
			...
			//mail("siddish.gollapelli@ideabytes.com","SES Check $to",print_r($message,true),$this->mHeader);
			mail($to,$subject,print_r($message,true),$this->mHeader);
	...
	public function  welcome_email_with_activation($u_email, $user_login, $user_pass,  $activation_link)
	{
		...
		$template_admim = stripslashes($this->get_option('messaging_welcome_email_with_activation_admin'));
			...
			$template_admim="Hi Admin, <br> <p>New User Registered at ".site_url()." .</p><p>Account e-mail: {{userultra_user_email}} </p><p>Account username: {{userultra_user_name}}</p><p>Account Facebook id:{{userultra_fb_id}} </p> <br /> <p>Regards,</p><p>QezyPlay</p>";}
...
<p>You have been subscribed to Shonar Bangla a premium Bouquet of Live TV channels which has Bengali Channels for your enjoyment.</p>
