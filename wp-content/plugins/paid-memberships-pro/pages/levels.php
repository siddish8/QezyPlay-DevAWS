...
$promo_text='<br><sup>*Promo Code Used</sup>';
	if ((strpos($_SERVER['HTTP_USER_AGENT'], 'Mobile/') !== false) && (strpos($_SERVER['HTTP_USER_AGENT'], 'Safari/') == false) or ($_SERVER['HTTP_X_REQUESTED_WITH'] == "com.ib.qezyplay") or $_SESSION['app']==1) {
		$promo_text='<br><sup>*Bonus Code Used</sup>';
	}
}
else
{
...
swal({
				  title:'Please Register to avail Free -Trial', 
				  text: '<a href=\"javascript:void(0)\" ><button onclick=\"swal.cancelAlert()\" style=\"height: 8px; width: 14px; padding: 8px 0px; position: absolute; top: -55px; right: -20px; background: none !important; color: #77909F !important;border-radius: 0px !important; text-align: center; font-size: 18px; border: none !important;\" type=\'button\'>&#x2715;</button></a>',
				  type: 'warning',
				  html:true,
				  showCancelButton: false,  cancelButtonColor:"#607D8B !important", confirmButtonColor: "#8CD4F5",   confirmButtonText: "OK",   cancelButtonText: ""
				},function(isConfirm){
