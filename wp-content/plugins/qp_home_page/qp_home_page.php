...
if(!is_user_logged_in()) { 
echo "<script>
jQuery(document).on('ready', function() {document.querySelector('div[slidesjs-index=\"4\"] button').innerHTML='SIGN UP <br> <span style=\"font-size:18px\">Enjoy Free Viewing </span>'});
</script>";}
else
{
echo "<script>
jQuery(document).on('ready', function() {document.querySelector('div[slidesjs-index=\"4\"] button').style.display='none'});
</script>";
} 
