...
<div align="center" style="margin:0 auto;background-color:yellowgreen" ><p>Enjoy Viewing LIVE channels <?php if($app==0) { ?> <a style="font-size:18px" class="blink" onclick="return player_url()" href="#">Here</a> <?php } ?> </p>	</div>
