...
//exit;
						...
						$resSU=get_all("SELECT user_email,user_login,display_name from wp_users where ID in (1,29,47,1980,1933,1547,1475,1489,1505)");
						$resUS=get_all("SELECT user_email,user_login,display_name from wp_users where ID not in (1,29,47,1980,1933,1547,1475,1489,1505)");
