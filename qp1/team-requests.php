...
if(isset($_REQUEST['delAR'])){
	...
	$msg = "<span id='msg' style='color:green'>Request deleted Successfully</span>";
...
if(isset($_POST['Add_Submit'])){
	...
	echo $tm_id=$_REQUEST['tm_id'];
	echo $tm_name=$_REQUEST['tm_name'];
	
	echo $rqname=trim($_POST['rqname']);
	echo $site=trim($_POST['site']);
	echo $rqdesc=trim($_POST['rqdesc']);

	echo $status="pending";	
	echo $date = gmdate("Y-m-d H:i:s");	
...
<h2 style="text-align:center">Team Requests</h2>
...
?>	
<div class="msg" align="center" style="display:inline-block"><h4 id="ad-msg"><?php echo $msg;?></h4></div>
<!--
...
<section class="section">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title">
							Requested to Admin &nbsp; <a href="team-requests"><button class="btn btn-primary">REFRESH</button></a>
						</h3> </div>
		...
		<form id="frm2" method="post">
		 <div class="table-responsive">
			...
			$sql22="SELECT * FROM team_requests where rq_name<>'' ";
			...
			?>
				...
				<select onchange="updateStatus(<?php echo $id;?>)" id="rq_status">
				...
				<td style="width: 200px;" class="level_name"><?php echo $date;?></td>	
...
function updateStatus(Rqid){
	//alert(Rqid);
	//alert(jQuery("#rq_status").val());
	var status=jQuery("#rq_status").val();
	var values={"action":"upadteTMreqStatus","rq_id":Rqid,"status":status};
