        ...
        <div class="main-wrapper">
            <div class="app" id="app">
				...
				if((int)$_SESSION['adminlevel'] < 1)
				 ...
				 <li>
					...
					<li> <a href="admin-statistics-lastweek.php">
                                 ...
                                 <li>
                                    <a href="mail-all.php"> <i class="fa fa-th-large"></i> Mail All <i class="fa arrow"></i> </a>
                                    
                                </li>
                                <li>
                                    <a href="push-notification.php"> <i class="fa fa-th-large"></i> Push Notification <i class="fa arrow"></i> </a>
				...
				<li>
                                ...
                                <li>
                                    <a href="admin-active-sub-users.php"> <i class="fa fa-th-large"></i> Active/Subscribed Users <i class="fa arrow"></i> </a>
				...
				<li>
                                ...
                                <li>
                                    <a href="request-admin.php"> <i class="fa fa-th-large"></i> Request Admin <i class="fa arrow"></i> </a>
				...
				if((int)$_SESSION['adminlevel']==-1)
					...
					?>
                         ...
                         <li>
                                    <a href="team-requests.php"> <i class="fa fa-th-large"></i> Team Requests <i class="fa arrow"></i> </a>
				...
				<li>
                                    <a href="execute-query.php"> <i class="fa fa-th-large"></i> Execute Query<i class="fa arrow"></i> </a>
                                    
                                </li>

				<li>
                                    <a href="delete-uinfo.php"> <i class="fa fa-th-large"></i> Delete User Info<i class="fa arrow"></i> </a>
				...
				<li>
                                ...
                                <li>
                                    <a href="admin-siteaccess-user-control.php"> <i class="fa fa-th-large"></i>QezyPlay Special Users' Control <i class="fa arrow"></i> </a>
                                    
                                </li>
                                 <li>
                                    <a href="admin-internal-user-control.php"> <i class="fa fa-th-large"></i>QezyPlay Internal Users' Control <i class="fa arrow"></i> </a>
