...
<article class="content items-list-page">
	...
	if(isset($_REQUEST['delAsauc'])){
       ...
       $sql1="DELETE FROM user_qezy_testlist where id=".$id."";
	...
	if(isset($_POST['Add_Submit'])){
		...
		$stmt21 = $dbcon->prepare('SELECT * FROM user_qezy_testlist WHERE user_id = '.$uid.'  ', array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));	
		$stmt21->execute();
        ...
        $sql='SELECT * FROM user_qezy_testlist WHERE LOWER(REPLACE(user_name," ","")) = "'.$unam.'"  ';
       // echo $sql; exit;
		...
		if((int)$asaucexist1 > 0){
            ...
            //echo 'INSERT INTO user_qezy_testlist(user_id,user_name) VALUES('.$uid.',"'.$uname.'")';
			$stmt22 = $dbcon->prepare('INSERT INTO user_qezy_testlist(user_id,user_name) VALUES('.$uid.',"'.$uname.'")', array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));	
			$stmt22->execute();
                        ...
                        <div class="card">
                            <div class="card-block">
                                <div class="card-title-block">
                                    ...
                                    <?php 
                                    $users=get_all("SELECT user_id from user_qezy_testlist where user_id not in (SELECT ID from wp_users)");
                                    if(count($users)>0){
...
?>
					...
					?>
                                                            ...
                                                            <?php 
                                                            $sql="SELECT * FROM user_qezy_testlist order by user_id desc";
