        ...
        <div class="main-wrapper">
            <div class="app" id="app">
    			      ...
    			      <span class="counter">8</span>
                            ...
                            <li class="profile dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="img" style="width:60px;height:35px;background-image: url('<?php echo UPLOAD_FOLDER1.$logo;?>')"> </div> <span class="name">
    			     <?php echo $cName; ?>
    			    </span> </a>
                                <div class="dropdown-menu profile-dropdown-menu" aria-labelledby="dropdownMenu1">
					<!-- <div ><img style="max-width:100%" src="../qp1/customer_logo/<?php echo $logo;?>" /></div>-->
                    <div ><img style="max-width:100%" src="<?php echo UPLOAD_FOLDER1.$logo;?>" /></div>
				...
				<img class="logo1" alt="" src='../qp1/assets/images/qp_logo.png' style="width: 100px; height: 50px">
				 ...
				 <li><a href="broadcaster-all-statistics.php"><i class="fa fa-th-large"></i>All Statistics<i class="fa arrow"></i> </a>
                                    
                                </li>
				 <li><a href="broadcaster-daily-statistics.php"><i class="fa fa-th-large"></i>Daily Statistics<i class="fa arrow"></i> </a>
                                    
                                </li>
				 <li><a href="broadcaster-monthly-statistics.php"><i class="fa fa-th-large"></i>Monthly Statistics<i class="fa arrow"></i> </a>
                                    
                                </li>
				<li><a href="broadcaster-yearly-statistics.php"><i class="fa fa-th-large"></i>Yearly Statistics<i class="fa arrow"></i> </a>
                                    
                                </li>
				 <li><a href="broadcaster-statistics-by-region.php"><i class="fa fa-th-large"></i>Statistics by Region<i class="fa arrow"></i> </a>
                                    
                                </li>
				 <li><a href="broadcaster-statistics-by-device.php"><i class="fa fa-th-large"></i>Statistics by Device<i class="fa arrow"></i> </a>
				...
				<!--<li>
                                    <a href="broadcaster-extra-analytics.php"> <i class="fa fa-th-large"></i>Extra Statistics <i class="fa arrow"></i> </a>
