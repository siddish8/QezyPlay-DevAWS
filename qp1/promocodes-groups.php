                                                ...
                                                <section class='example'>
                                                    <div class='table-responsive' align='center'>
                                                        <table class='table table-striped table-bordered table-hover' style='max-width:600px;max-height:400px'>
                                                            ...
                                                            <tbody id='user_details' align="center" style="margin:0 auto;text-align:center">
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </section>
            ...
            <script>
                ...
                function user_details(id, pc) {
                    ...
                    var values = {
                     ...
                     jQuery("#user_details").html('<tr><td colspan="5"><img src="../qp/images/Radar.gif" alt="Be patient..." /></td></tr>');
