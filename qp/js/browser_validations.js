...
function validate(id) {
    ...
    if (id == "xoouserultra-register-btn") {
		...
		*/
        ...
        if (val0.value == "") {
            ...
            document.getElementById("phone-help").style.color = "red !important";
            document.getElementById("phone_err_div").style.display = "block";
            document.getElementById("phone_err").innerHTML = "Please select a Country";
        ...
        if (val3.value == "") {
            ...
            jQuery("#ph").val(ph);
            //alert(ph);
            var phone = "+" + val0.value + jQuery("#ph").val();
		...
		//<p class='saving'>Processing  <span class='dt'>.</span><span class='dt'>.</span><span class='dt'>.</span></p>
        swal({
            title: "",
            text: "<p class='saving'>Processing  <span class='dt'>.</span><span class='dt'>.</span><span class='dt'>.</span></p> <br> <img style='border: 1px solid #ECE2AE !important;border-radius:50%' src='../qp/images/Rainbow.gif' alt='Registering...' />",
            type: "warning",
            html: "true",
    ...
    if (id == "phone" || id == "phone_fb" || id == "phone_cf") {
		...
		//countrycode check for registration form PHONE
        if (id == "phone") {
            var val0 = document.getElementById("countryCode");
            if (val0.value == "") {
                jQuery("#phone-help").css("color", "black");
                val0.style.border = "1px solid rgb(210, 8, 8)";
                val0.style.boxShadow = "0px 0px 10px rgb(210, 8, 8)";
                val0.style.outline = "medium none";
                /*document.getElementById(id + "_err_div").style.display = "block";
                document.getElementById(id + "_err").innerHTML = "Please select a Country";*/
                return false;
            } else {
    ...
    if (id == "xoouserultra-update") {
        ...
        if (val3.value == "") {
            ...
            val3.style.outline = "medium none";
            document.getElementById("phone_err_div").style.display = "block";
            document.getElementById("phone_err").innerHTML = "Please enter phone no.";
            return false;
        } else if (!check && (val3.value != "")) {
            val3.style.border = "1px solid rgb(210, 8, 8)";
            val3.style.boxShadow = "0px 0px 10px rgb(210, 8, 8)";
