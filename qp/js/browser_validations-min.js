...
function validate(id) {
    ...
    if (id == "qz-register-btn") {
        ...
        var values = { "username": val1.value, "email": val2.value, "password": val5.value, "phone": ph, "cc": val7.value, "ip": val99.value, "countryCode": countryCode }
        jQuery.ajax({
            url: site_url + "/webservices/api.php?request=register",
            type: "POST",
            data: values,
            success: function(data, textStatus, request) {
                if (data.status == 1) {
                    ...
                    swal({
                        ...
                        function() {
                            window.location.href = site_url + "/QP/sign-up";
                        });
                                ...
                                jQuery.ajax({
                                    ...
                                    success: function(data) {
                                        swal({ title: "", text: data, html: true },
                                            function(isConfirm) { window.location.href = site_url + "/QP/sign-up"; });
                                        return true;
                                    }
                                });
                                return false;
